...
const PATTERN: React.CSSProperties = {
  opacity: 0,
  backgroundColor: CREAM,
  WebkitMaskImage: "url(/Pattern.svg), linear-gradient(to top, #000, transparent 85%)",
  maskImage: "url(/Pattern.svg), linear-gradient(to top, #000, transparent 85%)",
  ...
  return (
    ...
    >
      ...
      <div
        data-loader-pattern
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 bottom-0 h-[52vh] opacity-[0.045]"
        style={PATTERN}
      />
